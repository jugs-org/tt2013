...
public final class RolleRegionNordConstraint
{
	...
	/**
	 * Constraintsafe member _05_switch.enums.Region.Nord regionNord.
	 */
	public final _05_switch.enums.Region.Nord regionNord;
			...
			final Rolle rolle )
	{
		...
		this.rolle = rolle;
		this.regionNord = (_05_switch.enums.Region.Nord) ( ( Rolle.Niederlassung ) rolle ).region;
	}
