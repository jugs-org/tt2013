...
public final class ANDB_Buzz_NOT_Fizz_ANDE
{
	 ...
	 */
	public ANDB_Buzz_NOT_Fizz_ANDE(
			final Integer value )
	{
		if ( ! test( value ) )
		{
	...
	{
		return "(Buzz and not(Fizz)): " + this.value;	}
