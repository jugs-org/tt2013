 ...
 * Line-Number 134.
 */
public final class ORB_RolleEbeneZentrale_RolleEbeneNiederlassung_ORE
{
	/**
	 ...
	 */
	public ORB_RolleEbeneZentrale_RolleEbeneNiederlassung_ORE(
			final Rolle rolle )
	{
		if ( ! test( rolle ) )
		{
	...
	{
		return "(RolleEbeneZentrale or RolleEbeneNiederlassung): " + this.rolle;
	}
