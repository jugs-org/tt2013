...
public final class StringConstraintUtil
{
    ...
    /**
     * Zurückgeben der ersten gefundenen
     * Prädikates für das erste Zeichen
     * des Strings.
     * 
     * @param primitivPredicateSet
     * @return StrFirstCharacter-Prädikat oder null, wenn nichts gefunden
     */
    public static StrFirstCharacter getStrFirstCharacterPredicate(
            final ReadOnlySet<PrimitivPredicate<String>> primitivPredicateSet )
    {
        for ( final PrimitivPredicate<String> primitivPredicate : primitivPredicateSet )
        {
            if ( primitivPredicate instanceof StrFirstCharacter )
            {
                return (StrFirstCharacter) primitivPredicate;
            }
        }
        return null;
    }
    ...
    /**
     * Zurückgeben der ersten gefundenen
     * Prädikates für das letzte Zeichen
     * des Strings.
     * 
     * @param primitivPredicateSet
     * @return StrFirstCharacter-Prädikat oder null, wenn nichts gefunden
     */
    public static StrLastCharacter getStrLastCharacterPredicate(
            final ReadOnlySet<PrimitivPredicate<String>> primitivPredicateSet )
    {
        for ( final PrimitivPredicate<String> primitivPredicate : primitivPredicateSet )
        {
            if ( primitivPredicate instanceof StrLastCharacter )
            {
                return (StrLastCharacter) primitivPredicate;
            }
        }
        return null;
    }
