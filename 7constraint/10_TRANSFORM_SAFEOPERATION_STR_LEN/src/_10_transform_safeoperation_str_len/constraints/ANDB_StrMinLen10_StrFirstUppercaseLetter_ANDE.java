 ...
 * Line-Number 103.
 */
public final class ANDB_StrMinLen10_StrFirstUppercaseLetter_ANDE
{
	/**
	 ...
	 */
	public ANDB_StrMinLen10_StrFirstUppercaseLetter_ANDE(
			final String str )
	{
		if ( ! test( str ) )
		{
	...
	{
		return "(StrMinLen10 and StrFirstUppercaseLetter): " + this.str;
	}
