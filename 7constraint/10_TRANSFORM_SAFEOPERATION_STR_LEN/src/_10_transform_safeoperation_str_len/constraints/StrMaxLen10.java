 ...
 * Line-Number 74.
 */
public final class StrMaxLen10
{
	/**
	...
	public static boolean test(
			final String str )
	{
		return new StrMaxLen( 10 ).test( str );
	}
	 ...
	 */
	public StrMaxLen12 convertToStrMaxLen12()
	{
		return new StrMaxLen12(
				this.str );
	}
