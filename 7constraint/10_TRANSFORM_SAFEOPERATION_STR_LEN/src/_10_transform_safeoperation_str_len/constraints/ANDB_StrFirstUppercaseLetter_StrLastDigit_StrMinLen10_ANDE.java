 ...
 * Line-Number 179.
 */
public final class ANDB_StrFirstUppercaseLetter_StrLastDigit_StrMinLen10_ANDE
{
	/**
	 ...
	 */
	public ANDB_StrFirstUppercaseLetter_StrLastDigit_StrMinLen10_ANDE(
			final String str )
	{
		if ( ! test( str ) )
		{
	 ...
	 */
	public ANDB_StrMinLen10_StrFirstUppercaseLetter_StrLastDigit_ANDE convertToANDB_StrMinLen10_StrFirstUppercaseLetter_StrLastDigit_ANDE()
	{
		return new ANDB_StrMinLen10_StrFirstUppercaseLetter_StrLastDigit_ANDE(
				this.str );
	}
	...
	{
		return "(StrFirstUppercaseLetter and StrLastDigit and StrMinLen10): " + this.str;
	}
