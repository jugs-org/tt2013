 ...
 * Line-Number 148.
 */
public final class ANDB_StrMinLen10_StrMaxLen32_ANDE
{
	/**
	 ...
	 */
	public ANDB_StrMinLen10_StrMaxLen32_ANDE(
			final String str )
	{
		if ( ! test( str ) )
		{
	...
	{
		return "(StrMinLen10 and StrMaxLen32): " + this.str;
	}
