 ...
 * Line-Number 0.
 */
public final class ANDB_StrFirstUppercaseLetter_StrMinLen5_ANDE
{
	/**
	 ...
	 */
	public ANDB_StrFirstUppercaseLetter_StrMinLen5_ANDE(
			final String str )
	{
		if ( ! test( str ) )
		{
	...
	{
		return "(StrFirstUppercaseLetter and StrMinLen5): " + this.str;
	}
