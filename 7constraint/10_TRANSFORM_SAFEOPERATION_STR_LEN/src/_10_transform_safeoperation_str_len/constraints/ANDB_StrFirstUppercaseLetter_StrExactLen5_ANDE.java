 ...
 * <pre>(StrFirstUppercaseLetter and StrExactLen5).</pre>
 * Generated by {@link _10_transform_safeoperation_str_len.TransformSafeOperationStrLenConstraintCodeGenerator}.
 * Line-Number 0.
 */
public final class ANDB_StrFirstUppercaseLetter_StrExactLen5_ANDE
{
	/**
	 ...
	 */
	public ANDB_StrFirstUppercaseLetter_StrExactLen5_ANDE(
			final String str )
	{
		if ( ! test( str ) )
		{
	...
	/**
	 * Convert this constraint type to a compatible type of this type.
	 * <pre>StrExactLen5.</pre>
	 * 
	 * @return compatible type of this type
	 */
	public StrExactLen5 convertToStrExactLen5()
	{
		return new StrExactLen5(
				this.str );
	}
	...
	{
		return "(StrFirstUppercaseLetter and StrExactLen5): " + this.str;
	}
